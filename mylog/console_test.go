...
func ExampleConsoleWriter() {
	log := New(ConsoleWriter{Out: os.Stdout, NoColor: true})
...
func TestConsoleLogger(t *testing.T) {
	t.Run("Numbers", func(t *testing.T) {
		buf := &bytes.Buffer{}
		log := New(ConsoleWriter{Out: buf, NoColor: true})
		log.Info().
			Float64("float", 1.23).
			Uint64("small", 123).
...
func TestConsoleWriter(t *testing.T) {
	...
	t.Run("Unix timestamp ms input format", func(t *testing.T) {
		...
		TimeFieldFormat = TimeFormatUnixMs
	...
	t.Run("Unix timestamp us input format", func(t *testing.T) {
		...
		TimeFieldFormat = TimeFormatUnixMicro
...
func TestConsoleWriterConfiguration(t *testing.T) {
	...
	t.Run("Sets PartsExclude", func(t *testing.T) {
		buf := &bytes.Buffer{}
		w := ConsoleWriter{Out: buf, NoColor: true, PartsExclude: []string{"time"}}
	...
	t.Run("Sets FieldsExclude", func(t *testing.T) {
		buf := &bytes.Buffer{}
		w := ConsoleWriter{Out: buf, NoColor: true, FieldsExclude: []string{"foo"}}
